            ...
            <section className="about-us">
                <div className="about-c">
                    ...
                    <div className="text">
                        ...
                        <div className="data">
                            <a href="https://github.com/xiega" className="hire">Hire Me</a>
                        </div>
                    </div>
                </div>
            </section>
            <section className="about-us">
                <div className="about-c">
                    <div className="text">
                        ...
                        <div className="data">
                            <a href="https://github.com/DajWaj" className="hire">Hire Me</a>
                        </div>
                    </div>
            ...
            <section className="about-us">
                <div className="about-c">
                    ...
                    <div className="text">
                        ...
                        <div className="data">
                            <a href="https://github.com/Dzilne" className="hire">Hire Me</a>
                        </div>
                    </div>
                </div>
            </section>
